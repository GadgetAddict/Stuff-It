...
public enum SCLAlertViewStyle {
    case itemToBox, success, error, notice, warning, info, edit, wait, question, qrSearch
...
open class SCLAlertView: UIViewController {
    ...
    // showItem-Add/Edit Box   (view, title, subTitle)
    @discardableResult
    open func showItemAssignBox(_ title: String, subTitle: String, closeButtonTitle:String?=nil, icon: UIImage, duration:TimeInterval=0.0, colorStyle: UInt?=SCLAlertViewStyle.itemToBox.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: SCLAnimationStyle = .topToBottom) -> SCLAlertViewResponder {
        return showTitle(title, subTitle: subTitle, duration: duration, completeText:closeButtonTitle, style: .itemToBox, colorStyle: colorStyle, colorTextButton: colorTextButton, circleIconImage: icon, animationStyle: animationStyle)
    }
    ...
    // showNotice(view, title, subTitle)
    @discardableResult
    open func showQRerror(_ title: String, subTitle: String, closeButtonTitle:String?=nil, duration:TimeInterval=0.0, colorStyle: UInt=SCLAlertViewStyle.qrSearch.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: SCLAnimationStyle = .topToBottom) -> SCLAlertViewResponder {
        return showTitle(title, subTitle: subTitle, duration: duration, completeText:closeButtonTitle, style: .qrSearch, colorStyle: colorStyle, colorTextButton: colorTextButton, circleIconImage: circleIconImage, animationStyle: animationStyle)
    }
    ...
    open func showTitle(_ title: String, subTitle: String, duration: TimeInterval?, completeText: String?, style: SCLAlertViewStyle, colorStyle: UInt?=0x000000, colorTextButton: UInt?=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: SCLAnimationStyle = .topToBottom) -> SCLAlertViewResponder {
        ...
        case .qrSearch:
            iconImage = checkCircleIconImage(circleIconImage, defaultImage:SCLAlertViewStyleKit.imageOfQR_Search)
        }
...
class SCLAlertViewStyleKit : NSObject {
    ...
    struct Cache {
        ...
        static var imageOfQR_Search: UIImage?
    }
    ...
    class func drawQR_Search(){
        ...
        bezierPath.move(to: CGPoint(x: 12.85, y: 47.38))
        bezierPath.addLine(to: CGPoint(x: 20.38, y: 47.38))
        bezierPath.addCurve(to: CGPoint(x: 18.67, y: 45.86), controlPoint1: CGPoint(x: 19.79, y: 46.91), controlPoint2: CGPoint(x: 19.22, y: 46.41))
        bezierPath.addCurve(to: CGPoint(x: 13.44, y: 36.41), controlPoint1: CGPoint(x: 15.97, y: 43.16), controlPoint2: CGPoint(x: 14.22, y: 39.87))
        bezierPath.addLine(to: CGPoint(x: 12.85, y: 36.41))
        bezierPath.addLine(to: CGPoint(x: 12.85, y: 30.92))
        bezierPath.addLine(to: CGPoint(x: 7.36, y: 30.92))
        bezierPath.addLine(to: CGPoint(x: 7.36, y: 36.41))
        bezierPath.addLine(to: CGPoint(x: 1.86, y: 36.41))
        bezierPath.addLine(to: CGPoint(x: 1.86, y: 41.89))
        bezierPath.addLine(to: CGPoint(x: 12.85, y: 41.89))
        bezierPath.addLine(to: CGPoint(x: 12.85, y: 47.38))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 2.41, y: 49.57))
        bezierPath.addLine(to: CGPoint(x: 2.41, y: 73.7))
        bezierPath.addLine(to: CGPoint(x: 26.6, y: 73.7))
        bezierPath.addLine(to: CGPoint(x: 26.6, y: 50.66))
        bezierPath.addCurve(to: CGPoint(x: 23.86, y: 49.57), controlPoint1: CGPoint(x: 25.67, y: 50.36), controlPoint2: CGPoint(x: 24.75, y: 50))
        bezierPath.addLine(to: CGPoint(x: 2.41, y: 49.57))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 21.24, y: 68.35))
        bezierPath.addLine(to: CGPoint(x: 7.77, y: 68.35))
        bezierPath.addLine(to: CGPoint(x: 7.77, y: 54.92))
        bezierPath.addLine(to: CGPoint(x: 21.24, y: 54.92))
        bezierPath.addLine(to: CGPoint(x: 21.24, y: 68.35))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 18.63, y: 57.52))
        bezierPath.addLine(to: CGPoint(x: 10.38, y: 57.52))
        bezierPath.addLine(to: CGPoint(x: 10.38, y: 65.75))
        bezierPath.addLine(to: CGPoint(x: 18.63, y: 65.75))
        bezierPath.addLine(to: CGPoint(x: 18.63, y: 57.52))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 45.84, y: 18.06))
        bezierPath.addLine(to: CGPoint(x: 45.84, y: 8.98))
        bezierPath.addLine(to: CGPoint(x: 40.34, y: 8.98))
        bezierPath.addLine(to: CGPoint(x: 40.34, y: 3.5))
        bezierPath.addLine(to: CGPoint(x: 34.84, y: 3.5))
        bezierPath.addLine(to: CGPoint(x: 34.84, y: 8.98))
        bezierPath.addLine(to: CGPoint(x: 29.35, y: 8.98))
        bezierPath.addLine(to: CGPoint(x: 29.35, y: 12.96))
        bezierPath.addCurve(to: CGPoint(x: 45.84, y: 18.06), controlPoint1: CGPoint(x: 35.15, y: 12.03), controlPoint2: CGPoint(x: 41.29, y: 13.74))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 17.49, y: 19.68))
        bezierPath.addCurve(to: CGPoint(x: 18.63, y: 18.43), controlPoint1: CGPoint(x: 17.85, y: 19.25), controlPoint2: CGPoint(x: 18.23, y: 18.84))
        bezierPath.addLine(to: CGPoint(x: 18.63, y: 11.45))
        bezierPath.addLine(to: CGPoint(x: 10.38, y: 11.45))
        bezierPath.addLine(to: CGPoint(x: 10.38, y: 19.68))
        bezierPath.addLine(to: CGPoint(x: 17.49, y: 19.68))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 15.64, y: 22.28))
        bezierPath.addLine(to: CGPoint(x: 7.77, y: 22.28))
        bezierPath.addLine(to: CGPoint(x: 7.77, y: 8.85))
        bezierPath.addLine(to: CGPoint(x: 21.24, y: 8.85))
        bezierPath.addLine(to: CGPoint(x: 21.24, y: 16.23))
        bezierPath.addCurve(to: CGPoint(x: 26.6, y: 13.6), controlPoint1: CGPoint(x: 22.91, y: 15.06), controlPoint2: CGPoint(x: 24.72, y: 14.19))
        bezierPath.addLine(to: CGPoint(x: 26.6, y: 3.5))
        bezierPath.addLine(to: CGPoint(x: 2.41, y: 3.5))
        bezierPath.addLine(to: CGPoint(x: 2.41, y: 27.63))
        bezierPath.addLine(to: CGPoint(x: 13.49, y: 27.63))
        bezierPath.addCurve(to: CGPoint(x: 15.64, y: 22.28), controlPoint1: CGPoint(x: 13.93, y: 25.77), controlPoint2: CGPoint(x: 14.65, y: 23.97))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 56.84, y: 47.38))
        bezierPath.addLine(to: CGPoint(x: 56.84, y: 48.92))
        bezierPath.addLine(to: CGPoint(x: 60.65, y: 52.72))
        bezierPath.addCurve(to: CGPoint(x: 60.78, y: 52.86), controlPoint1: CGPoint(x: 60.69, y: 52.76), controlPoint2: CGPoint(x: 60.74, y: 52.81))
        bezierPath.addLine(to: CGPoint(x: 62.34, y: 52.86))
        bezierPath.addLine(to: CGPoint(x: 62.34, y: 47.38))
        bezierPath.addLine(to: CGPoint(x: 56.84, y: 47.38))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 64.81, y: 11.45))
        bezierPath.addLine(to: CGPoint(x: 56.56, y: 11.45))
        bezierPath.addLine(to: CGPoint(x: 56.56, y: 19.68))
        bezierPath.addLine(to: CGPoint(x: 64.81, y: 19.68))
        bezierPath.addLine(to: CGPoint(x: 64.81, y: 11.45))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 48.59, y: 3.5))
        bezierPath.addLine(to: CGPoint(x: 48.59, y: 21.31))
        bezierPath.addCurve(to: CGPoint(x: 51.36, y: 27.63), controlPoint1: CGPoint(x: 49.91, y: 23.27), controlPoint2: CGPoint(x: 50.83, y: 25.41))
        bezierPath.addLine(to: CGPoint(x: 72.78, y: 27.63))
        bezierPath.addLine(to: CGPoint(x: 72.78, y: 3.5))
        bezierPath.addLine(to: CGPoint(x: 48.59, y: 3.5))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 67.42, y: 22.28))
        bezierPath.addLine(to: CGPoint(x: 53.95, y: 22.28))
        bezierPath.addLine(to: CGPoint(x: 53.95, y: 8.85))
        bezierPath.addLine(to: CGPoint(x: 67.42, y: 8.85))
        bezierPath.addLine(to: CGPoint(x: 67.42, y: 22.28))
        bezierPath.addLine(to: CGPoint(x: 67.42, y: 22.28))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 62.34, y: 58.34))
        bezierPath.addLine(to: CGPoint(x: 61.89, y: 58.34))
        bezierPath.addCurve(to: CGPoint(x: 60.65, y: 60.28), controlPoint1: CGPoint(x: 61.63, y: 59.05), controlPoint2: CGPoint(x: 61.22, y: 59.71))
        bezierPath.addCurve(to: CGPoint(x: 53.07, y: 60.28), controlPoint1: CGPoint(x: 58.56, y: 62.37), controlPoint2: CGPoint(x: 55.16, y: 62.37))
        bezierPath.addLine(to: CGPoint(x: 51.34, y: 58.55))
        bezierPath.addLine(to: CGPoint(x: 51.34, y: 63.83))
        bezierPath.addLine(to: CGPoint(x: 40.34, y: 63.83))
        bezierPath.addLine(to: CGPoint(x: 40.34, y: 52.86))
        bezierPath.addLine(to: CGPoint(x: 45.63, y: 52.86))
        bezierPath.addLine(to: CGPoint(x: 41.88, y: 49.12))
        bezierPath.addCurve(to: CGPoint(x: 34.84, y: 51.4), controlPoint1: CGPoint(x: 39.68, y: 50.34), controlPoint2: CGPoint(x: 37.28, y: 51.1))
        bezierPath.addLine(to: CGPoint(x: 34.84, y: 69.31))
        bezierPath.addLine(to: CGPoint(x: 67.83, y: 69.31))
        bezierPath.addLine(to: CGPoint(x: 67.83, y: 52.86))
        bezierPath.addLine(to: CGPoint(x: 62.34, y: 52.86))
        bezierPath.addLine(to: CGPoint(x: 62.34, y: 58.34))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 62.34, y: 36.41))
        bezierPath.addLine(to: CGPoint(x: 56.84, y: 36.41))
        bezierPath.addLine(to: CGPoint(x: 56.84, y: 30.92))
        bezierPath.addLine(to: CGPoint(x: 51.86, y: 30.92))
        bezierPath.addCurve(to: CGPoint(x: 49.46, y: 41.56), controlPoint1: CGPoint(x: 52.08, y: 34.57), controlPoint2: CGPoint(x: 51.29, y: 38.28))
        bezierPath.addLine(to: CGPoint(x: 49.79, y: 41.89))
        bezierPath.addLine(to: CGPoint(x: 67.83, y: 41.89))
        bezierPath.addLine(to: CGPoint(x: 67.83, y: 30.92))
        bezierPath.addLine(to: CGPoint(x: 62.34, y: 30.92))
        bezierPath.addLine(to: CGPoint(x: 62.34, y: 36.41))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 51.13, y: 58.34))
        bezierPath.addLine(to: CGPoint(x: 45.84, y: 53.07))
        bezierPath.addLine(to: CGPoint(x: 45.84, y: 58.34))
        bezierPath.addLine(to: CGPoint(x: 51.13, y: 58.34))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 54.58, y: 58.21))
        bezierPath.addCurve(to: CGPoint(x: 58.57, y: 58.21), controlPoint1: CGPoint(x: 55.68, y: 59.31), controlPoint2: CGPoint(x: 57.47, y: 59.31))
        bezierPath.addCurve(to: CGPoint(x: 58.57, y: 54.23), controlPoint1: CGPoint(x: 59.67, y: 57.11), controlPoint2: CGPoint(x: 59.67, y: 55.33))
        bezierPath.addLine(to: CGPoint(x: 45.73, y: 41.41))
        bezierPath.addCurve(to: CGPoint(x: 43.9, y: 20.69), controlPoint1: CGPoint(x: 50.16, y: 35.1), controlPoint2: CGPoint(x: 49.56, y: 26.33))
        bezierPath.addCurve(to: CGPoint(x: 20.96, y: 20.69), controlPoint1: CGPoint(x: 37.56, y: 14.37), controlPoint2: CGPoint(x: 27.29, y: 14.37))
        bezierPath.addCurve(to: CGPoint(x: 20.96, y: 43.57), controlPoint1: CGPoint(x: 14.63, y: 27.01), controlPoint2: CGPoint(x: 14.63, y: 37.25))
        bezierPath.addCurve(to: CGPoint(x: 41.74, y: 45.4), controlPoint1: CGPoint(x: 26.62, y: 49.21), controlPoint2: CGPoint(x: 35.41, y: 49.82))
        bezierPath.addLine(to: CGPoint(x: 54.58, y: 58.21))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 24.95, y: 39.59))
        bezierPath.addCurve(to: CGPoint(x: 24.95, y: 24.67), controlPoint1: CGPoint(x: 20.82, y: 35.47), controlPoint2: CGPoint(x: 20.82, y: 28.79))
        bezierPath.addCurve(to: CGPoint(x: 39.91, y: 24.67), controlPoint1: CGPoint(x: 29.08, y: 20.55), controlPoint2: CGPoint(x: 35.78, y: 20.55))
        bezierPath.addCurve(to: CGPoint(x: 39.91, y: 39.59), controlPoint1: CGPoint(x: 44.04, y: 28.79), controlPoint2: CGPoint(x: 44.04, y: 35.48))
        bezierPath.addCurve(to: CGPoint(x: 24.95, y: 39.59), controlPoint1: CGPoint(x: 35.78, y: 43.72), controlPoint2: CGPoint(x: 29.08, y: 43.71))
        bezierPath.close()
    ...
    class var imageOfQR_Search: UIImage {
        if (Cache.imageOfQR_Search != nil) {
            return Cache.imageOfQR_Search!
        }
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 80, height: 80), false, 0)
        SCLAlertViewStyleKit.drawQR_Search()
        Cache.imageOfQR_Search = UIGraphicsGetImageFromCurrentImageContext()
        UIGraphicsEndImageContext()
        return Cache.imageOfQR_Search!
    }
}
